...
struct KTX2_HEADER_DXT10
{
  ktx2_DXGI_FORMAT dxgiFormat;
...
ResourceFormat DXGIFormat2ResourceFormat(ktx2_DXGI_FORMAT format)
{
...
ktx2_DXGI_FORMAT ResourceFormat2DXGIFormat(ResourceFormat format)
{
  if(format.Special())
  {
    switch(format.type)
